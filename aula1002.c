...
{
 char buffer [COMPRIMENTO_BUFFER + 2],extensao[] = ".bak",nome[COMPRIMENTO_NOME + 1];
 int fileDescriptor;
 ...
 while(fgets(buffer,COMPRIMENTO_BUFFER + 2,leitura))
 {
  #ifdef _MY_DEBUG
 ...
 fclose (leitura);
 fclose (escrita);
 printf ("\n\nArquivo passado para formato unix com sucesso!\n\n");
 return OK;
}
/* $RCSfile$ */
